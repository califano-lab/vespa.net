...
ddpi_substrate_regulon<-pruneRegulon(subset_regulon(ddpi_substrate_regulon, rownames(qmx), min_size=5), 50)
...
hsm_substrate_regulon<-pruneRegulon(subset_regulon(hsm_substrate_regulon, rownames(qmx), min_size=5), 50)
...
ddpihsm_substrate_regulon_optimized<-optimizeRegulon(qmx, ddpihsm_substrate_regulon, min_size=5)
