...
export2hparacne(qml, dirname(snakemake@output[["kinases"]]), kinases, phosphatases, hsmpf, target_sites, confidence_threshold = snakemake@params[["hsm_threshold"]], restrict_interactions=TRUE, interaction_level = "substrate")
