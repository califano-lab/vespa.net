...
export2hparacne(qml, dirname(snakemake@output[["kinases"]]), kinases, phosphatases, hsmd, unique(readRDS(snakemake@input[["ref"]])$site_id), confidence_threshold = snakemake@params[["hsm_threshold"]], interaction_level = "substrate")
