...
export2hparacne(yqml, dirname(snakemake@output[["kinases"]]), kinases, phosphatases, list("hsmp"=hsmpf,"pc"=pcdb,"lp"=lpadb), confidence_threshold = snakemake@params[["hsm_threshold"]], restrict_interactions=TRUE, interaction_level = "activity")
